...
/**
 * Avvia in felix il servizio di comunicazione OSCAR
 *
 * @author lucaBettelli
 */
public class OSCARActivator implements BundleActivator
{
	//Bundle's context
	...
	public void start(BundleContext context) throws Exception
	{
		...
		if (logger != null && controller != null && dataBase != null && configurator != null)//controlla se ha trovato i servizi e in caso contrario termina
		{
			...
			props.put("MP", "oscar");
			context.registerService(IComService.class.getName(), new OSCAR(configurator, logger, dataBase, controller), props);
		}
		else
		{
			System.out.println("OSCARActivator: mancano alcuni servizi necessari all'attivazione del servizio OSCAR");
		}
	}

	/**
	 * Deregistra il servizio OSCAR
	 *
	 * @param context
	 * @throws java.lang.Exception
	 */
	public void stop(BundleContext context) throws Exception
	{
		...
		System.out.println("OSCARActivator: stop");
	}
}
