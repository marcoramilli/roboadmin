...
/**
 * Avvia in felix il servizio di comunicazione IRC
 *
...
public class IRCActivator implements BundleActivator
{
	...
	public void start(BundleContext context) throws Exception
	{
		...
		if (logger != null && controller != null && configurator != null)//controlla se ha trovato i servizi e in caso contrario termina
		{
			Properties props = new Properties();
			props.put("MP", "irc");
			context.registerService(IComService.class.getName(), new IRC(configurator, dataBase, logger, controller), props);
		}
		else
		{
			System.out.println("IRCActivator: mancano alcuni servizi necessari all'attivazione del servizio IRC");
		}
	}
	...
	public void stop(BundleContext context) throws Exception
	{
		...
		System.out.println("IRCcom: stop");
	}
}
