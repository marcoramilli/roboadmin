...
/**
 * Avvia in felix il servizio di comunicazione XMPP
 *
 * @author lucaBettelli
 */
public class XMPPActivator implements BundleActivator
{
	//Bundle's context
	...
	public void start(BundleContext context) throws Exception
	{
		...
		if (logger != null && controller != null && dataBase != null && configurator != null)//controlla se ha trovato i servizi e in caso contrario termina
		{
			...
			props.put("MP", "xmpp");
			context.registerService(IComService.class.getName(), new XMPP(configurator, logger, dataBase, controller), props);
		}
		else
		{
			System.out.println("XMPPActivator: mancano alcuni servizi necessari all'attivazione del servizio XMPP");
		}
	}

	/**
	 * Deregistra il servizio XMPP
	 *
	 * @param context
	 * @throws java.lang.Exception
	 */
	public void stop(BundleContext context) throws Exception
	{
		...
		System.out.println("XMPPActivator: stop");
	}
}
