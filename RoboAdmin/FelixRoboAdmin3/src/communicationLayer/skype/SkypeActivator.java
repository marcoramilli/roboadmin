...
/**
 * Avvia in felix il servizio di comunicazione Skype
 *
 * @author lucaBettelli
 */
public class SkypeActivator implements BundleActivator
{
	//Bundle's context
	...
	public void start(BundleContext context) throws Exception
	{
		...
		if (logger != null && controller != null && dataBase != null && configurator != null)//controlla se ha trovato i servizi e in caso contrario termina
		{
			...
			props.put("MP", "msnp");
			context.registerService(IComService.class.getName(), new Skype(configurator, logger, dataBase, controller), props);
		}
		else
		{
	...
	public void stop(BundleContext context) throws Exception
	{
		...
		System.out.println("SkypeActivator: stop");
	}
}
